...
public class BookBorrowed extends JDialog {
    ...
    public void showBooks() {
        ...
        String SQLQuery = "SELECT * FROM BOOKS WHERE NAME LIKE '%" + searchStr + "%' OR SUBJECT LIKE '%" + searchStr + "%' OR AUTHOR LIKE '%" + searchStr + "%'";
        try {
    ...
    public static void main(String[] args) {
        BookBorrowed dialog = new BookBorrowed();
        dialog.pack();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        table1 = new JTable();
        panel3.add(table1, new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 2, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER, com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, null, new Dimension(150, 50), null, 0, false));
    }
