...
public class BooksReturned extends JDialog {
    ...
    public void showBooks() {
        ...
        String SQLQuery = "SELECT * FROM BOOKS WHERE NAME LIKE '%" + bookInfo + "%' OR AUTHOR LIKE '%" + bookInfo + "%' OR ISBN = " + Integer.parseInt(bookInfo);
        try {
            ...
            while (resultSet.next()) {
                ...
                try {
                    if (resultSet.getString("DUE_DATE") != null && new SimpleDateFormat("dd/MM/yyyy")
                        ...
                        String response = "BOOK IS OVERDUE PAY 50/- FEE";
                        JOptionPane.showMessageDialog(null, response);

                    } else {
                        String response = "BOOK RETURNED ON TIME";
                        JOptionPane.showMessageDialog(null, response);
                    }
    ...
    public static void main(String[] args) {
        BooksReturned dialog = new BooksReturned();
        dialog.pack();
